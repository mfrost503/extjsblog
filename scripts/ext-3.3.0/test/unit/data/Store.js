...
(function() {
    ...
    var defaultSetup = function() {
        ...
        this.store.loadData([
            ...
            ['Abe Elias',    'abe@extjs.com',   70,  'adminOld', false],
            ['Aaron Conran', 'aaron@extjs.com', 5,   'adminOld', true],
    ...
    suite.add(new Y.Test.Case({
        ...
        testCustomFilter: function() {
            ...
            this.store.filter({
                fn: function(record) {
                    execScope = this;
                    return record.get('group') == 'adminOld' && record.get('old') === true;
                },
                scope: this
            });
        ...
        testMultiCustomFilters: function() {
            this.store.filter([
                {
                    fn: function(record) {
                        return record.get('group') == 'adminOld';
                    }
                },
                {
                    fn: function(record) {
    ...
    suite.add(new Y.Test.Case({
        ...
        testCollectIsUnique: function() {
            ...
            assert.areNotEqual(-1, values.indexOf("adminOld"));
        }
    }));
